...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO purchase_history (id, product_id, purchase_date) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['id'], "int"),
                       GetSQLValueString($_POST['product_id'], "int"),
                       GetSQLValueString($_POST['purchase_date'], "date"));
...
mysql_select_db($database_chartjs, $chartjs);
$query_Recordset1 = "SELECT * FROM purchase_history";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Purchase_date:</td>
      <td><input type="text" name="purchase_date" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
...
<div class="container">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_Recordset1['purchase_date']; ?></td>
    </tr>
